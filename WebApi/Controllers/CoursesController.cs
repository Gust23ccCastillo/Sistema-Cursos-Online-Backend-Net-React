...
namespace WebApi.Controllers
{
    ...
    public class CoursesController : Principal_Base_Controller
    {
        ...
        {
            return await mediatorInject.Send(new GetUniqueCourseByParameter
        ...
        {
            return await this.mediatorInject.Send(new DeleteCourseInformation.DeleteInfoCourseAsync
